...
export default function ServiceCard({ icon, title, desc, onClick, delay = 0 }: ServiceCardProps) {
  return (
    <motion.button 
      type="button"
    ...
    >
      ...
      <h3 className="relative text-lg md:text-xl font-bold text-slate-800 leading-tight mb-1.5 md:mb-2 group-hover:text-primary group-active:text-primary transition-colors duration-300">
        {title}
      </h3>
      <p className="relative text-slate-500 text-sm md:text-base font-medium leading-snug max-w-[85%] text-left">
        {desc}
      </p>
